...
namespace percipiolondon\companymanagement\fields;

use percipiolondon\companymanagement\Companymanagement;
use percipiolondon\companymanagement\assetbundles\timeloopfield\TimeloopFieldAsset;
...
class Timeloop extends Field
{
    ...
    {
        return Craft::t('company-management', 'Timeloop');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'company-management/_components/fields/Timeloop_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').CompanymanagementTimeloop(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'company-management/_components/fields/Timeloop_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
