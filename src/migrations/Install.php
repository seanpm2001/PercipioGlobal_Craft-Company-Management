...
class Install extends Migration {
    ...
    public function createTables()
    {
        ...
        $tableSchemaUsers = Craft::$app->db->schema->getTableSchema(Table::CM_EMPLOYEES);
        ...
        if ($tableSchemaUsers === null) {
            $this->createTable(Table::CM_EMPLOYEES, [
                'id' => $this->primaryKey(),
                'dateCreated' => $this->dateTime()->notNull(),
                'dateUpdated' => $this->dateTime()->notNull(),
                'uid' => $this->uid(),
                ...
                'knownAs' => $this->string()->defaultValue(''),
                'nameTitle' => $this->string()->notNull()->defaultValue(''),
                'ethnicity' => $this->string()->defaultValue(''),
                'maritalStatus' => $this->string()->defaultValue(''),
                'drivingLicense' => $this->string()->defaultValue(''),
                'address' => $this->string()->defaultValue(''),
                'gender' => $this->string()->defaultValue(''),
                'nationality' => $this->string()->defaultValue(''),
                'dateOfBirth' => $this->dateTime()->notNull(),
                'joinDate' => $this->dateTime(),
        ...
        if ($tableSchemaPermissionsUsers === null) {
            $this->createTable(Table::CM_PERMISSIONS_EMPLOYEES, [
                'id' => $this->primaryKey(),
    ...
    public function dropTables()
    {
        ...
        $this->dropTableIfExists(Table::CM_EMPLOYEES);
